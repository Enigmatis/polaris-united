...
var AuthorService = /** @class */ (function () {
    ...
    AuthorService.prototype.findByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.authorRepository.find(this.ctx, {
    ...
    AuthorService.prototype.findByFirstName = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.authorRepository.find(this.ctx, {
                        where: { firstName: polaris_core_1.Like("%" + this.ctx.requestHeaders.customHeader + "%") },
                    })];
            });
        });
    };
    AuthorService.prototype.deleteAuthor = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authorRepository.delete(this.ctx, id)];
                    case 1:
                        result = _a.sent();
