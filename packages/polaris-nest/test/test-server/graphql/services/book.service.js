...
var polaris_core_1 = require("@enigmatis/polaris-core");
...
var BookService = /** @class */ (function () {
    ...
    BookService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.bookRepository.find(this.ctx, { relations: ["author"] })];
            });
        });
    };
    ...
    BookService.prototype.booksByTitle = function (title) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.bookRepository.find(this.ctx, {
    ...
    BookService.prototype.updateBooksByTitle = function (title, newTitle) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bookRepository.find(this.ctx, {
                            where: { title: polaris_core_1.Like("%" + title + "%") },
                        })];
                    case 1:
                        result = _a.sent();
                        ...
                        result.forEach(function (book) { return (book.title = newTitle); });
    ...
    BookService.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bookRepository.delete(this.ctx, id)];
                    case 1:
                        result = _a.sent();
