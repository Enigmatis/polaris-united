...
// import { generateString, mergeDefaults } from "@nestjs/graphql/dist/utils";
//
// @Module({
//   imports: [GraphQLSchemaBuilderModule, PolarisLoggerModule],
//   providers: [
//     GraphQLFactory,
//     MetadataScanner,
//     ResolversExplorerService,
...
// })
// export class PolarisGqlModule extends GraphQLModule {
//   constructor(
//     httpAdapterHost: HttpAdapterHost,
//     @Inject(GRAPHQL_MODULE_OPTIONS) options: GqlModuleOptions,
...
//       providers: [
//         ...this.createPolarisAsyncProviders(options),
//         {
...
//     };
//   }
//   private static createPolarisAsyncProviders(
//     options: GqlModuleAsyncOptions
//   ): Provider[] {
//     if (options.useExisting || options.useFactory) {
//       return [this.createPolarisAsyncOptionsProvider(options)];
//     }
//     return [
//       this.createPolarisAsyncOptionsProvider(options),
//       {
...
//   }
//
//   private static createPolarisAsyncOptionsProvider(
//     options: GqlModuleAsyncOptions
//   ): Provider {
...
//       super.onModuleInit().then(() => {
//         initSnapshotGraphQLOptions(
//           (this.loggerService.getPolarisLogger() as unknown) as PolarisGraphQLLogger,
//           this.configService.getPolarisServerConfig(),
